  ...
  Widget build(BuildContext context) {
    ...
    Padding(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.contact_page, color: MyColors.primary,),
          SizedBox(width: 5,),
          NormalText(text: "Contact", fontSize: 16, txtColor: MyColors.primary,),
        ],
      )
      ),
      ),
      ...
      alignment: Alignment.center,
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.group_sharp, color: MyColors.primary,),
              SizedBox(width: 5,),
              NormalText(text: "Group", fontSize: 16, txtColor: MyColors.primary,),
            ],
          )
      ),
      ),
