      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 10,),
            NormalText(text: "Bank account owner’s name must be match your name on your indetification card",fontSize: 14,overflow: TextOverflow.visible,),
            SizedBox(height: 20,),
            ...
            SizedBox(height: 20,),
            NormalTextField(hintText: "Bank Brand",controller: _bankBrand, suffix: Icon(Icons.keyboard_arrow_down, color: MyColors.black,),readOnly: true,contentPadding: const EdgeInsets.only(top: 15),),
          ],
        ),
      ),
      bottomSheet: Column(
